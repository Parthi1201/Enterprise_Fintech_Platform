...
const (
	PaymentService_CreatePayment_FullMethodName         = "/api.payment.PaymentService/CreatePayment"
	PaymentService_GetPayment_FullMethodName            = "/api.payment.PaymentService/GetPayment"
	PaymentService_ListPaymentsByAccount_FullMethodName = "/api.payment.PaymentService/ListPaymentsByAccount"
	PaymentService_UpdatePaymentStatus_FullMethodName   = "/api.payment.PaymentService/UpdatePaymentStatus"
)
...
type PaymentServiceClient interface {
	...
	ListPaymentsByAccount(ctx context.Context, in *ListPaymentsByAccountRequest, opts ...grpc.CallOption) (*ListPaymentsByAccountResponse, error)
...
func (c *paymentServiceClient) ListPaymentsByAccount(ctx context.Context, in *ListPaymentsByAccountRequest, opts ...grpc.CallOption) (*ListPaymentsByAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListPaymentsByAccountResponse)
	err := c.cc.Invoke(ctx, PaymentService_ListPaymentsByAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) ListPaymentsByAccount(context.Context, *ListPaymentsByAccountRequest) (*ListPaymentsByAccountResponse, error) {
...
func _PaymentService_ListPaymentsByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListPaymentsByAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).ListPaymentsByAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_ListPaymentsByAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ListPaymentsByAccount(ctx, req.(*ListPaymentsByAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PaymentService_ListPaymentsByAccount_Handler,
		},
		{
