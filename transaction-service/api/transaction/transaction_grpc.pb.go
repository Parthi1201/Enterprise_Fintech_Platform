...
const (
	TransactionService_CreateTransaction_FullMethodName         = "/api.transaction.TransactionService/CreateTransaction"
	TransactionService_GetTransaction_FullMethodName            = "/api.transaction.TransactionService/GetTransaction"
	TransactionService_ListTransactionsByAccount_FullMethodName = "/api.transaction.TransactionService/ListTransactionsByAccount"
)
...
type TransactionServiceClient interface {
	...
	ListTransactionsByAccount(ctx context.Context, in *ListTransactionsByAccountRequest, opts ...grpc.CallOption) (*ListTransactionsByAccountResponse, error)
}
...
func (c *transactionServiceClient) ListTransactionsByAccount(ctx context.Context, in *ListTransactionsByAccountRequest, opts ...grpc.CallOption) (*ListTransactionsByAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTransactionsByAccountResponse)
	err := c.cc.Invoke(ctx, TransactionService_ListTransactionsByAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransactionServiceServer) ListTransactionsByAccount(context.Context, *ListTransactionsByAccountRequest) (*ListTransactionsByAccountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTransactionsByAccount not implemented")
}
...
func _TransactionService_ListTransactionsByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTransactionsByAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).ListTransactionsByAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_ListTransactionsByAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).ListTransactionsByAccount(ctx, req.(*ListTransactionsByAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.transaction.TransactionService",
	...
	Metadata: "api/transaction/transaction.proto",
}
